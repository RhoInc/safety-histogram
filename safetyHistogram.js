(function (global, factory) {
    ...
    function runKolmogorovSmirnovTest() {
      ...
      var ks = jerzy.Nonparametric.kolmogorovSmirnov(x, y);
      return ks;
    }
    ...
    function drawSmallMultiples() {
      ...
      this.multiples.on('resize', function () {
        var ks = runKolmogorovSmirnovTest.call(this);
        this.wrap.select('.wc-chart-title').append('span').classed('sh-ks-test', true).text("p = ".concat(d3.format('.2f')(ks.p)));
        console.log(ks);
