(function (global, factory) {
    ...
    function defineMeasureData() {
        ...
        this.measure.stats.log10range = this.measure.stats.range > 0 ? Math.log10(this.measure.stats.range) : NaN;
        this.measure.stats.iqr = this.measure.stats.q75 - this.measure.stats.q25;

        //Calculate bin width and number of bins.
        this.measure.stats.binWidth = 2 * this.measure.stats.iqr / Math.pow(this.measure.stats.n, 1.0 / 3.0); // https://en.wikipedia.org/wiki/Freedman%E2%80%93Diaconis_rule
        this.measure.stats.calculatedBins = this.measure.stats.binWidth > 0 ? Math.ceil(this.measure.stats.range / this.measure.stats.binWidth) : NaN;
        this.measure.stats.nBins = this.measure.stats.calculatedBins < this.measure.stats.nUnique ? this.measure.stats.calculatedBins : this.measure.stats.nUnique;
    ...
    function calculateXPrecision() {
        ...
        var step = this.measure.stats.range > 0 ? Math.abs(this.measure.stats.range / 15) // non-zero range
